  ...
  return (
    <main className="container mx-auto p-4">
      <h1 className="text-3xl font-bold mb-4">
        Privacy Policy For Nani estates
      </h1>

      <p className="mb-4">
        At Naniestates.co.uk, accessible from https://Naniestates.co.uk/, one of
        ...
        RedMarsestates.co.uk and how we use it.
      </p>
      ...
      <p className="mb-4">
        ...
        shared and/or collect in RedMarsestates.co.uk. This policy is not
      ...
      <p className="mb-4">
        RedMarsestates.co.uk follows a standard procedure of using log files.
      ...
      <p className="mb-4">
        Like any other website, RedMarsestates.co.uk uses ‘cookies’. These
      ...
      <p className="mb-4">
        ...
        advertising partners of RedMarsestates.co.uk.
      </p>

      <p className="mb-4">
        Third-party ad servers or ad networks use technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on RedMarsestates.co.uk, which are
      ...
      <p className="mb-4">
        Note that RedMarsestates.co.uk has no access to or control over these
        cookies that are used by third-party advertisers.
      </p>

      <h2 className="text-2xl font-bold mb-2">Third Party Privacy Policies</h2>
      <p className="mb-4">
        RedMarsestates.co.uk’s Privacy Policy does not apply to other
      ...
      <p>
        RedMarsestates.co.uk does not knowingly collect any Personal
